...
{% include figure.liquid loading="eager" path="/assets/img/overlay_1.png" class=profile_image_class sizes=50vw alt=page.profile.image cache_bust=true max-width=260px %}
