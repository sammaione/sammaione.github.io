...
<div class="card mb-3" style="max-width: 1280px; card-cap-padding-x: 50px; card-cap-padding-y: 50px;">
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text font-italic">Samuel Maione & Shari Liu</p>
        ...
        <p class="card-text">
        [<a href="https://osf.io/7mtk8/" class="text-primary">OSF</a>]
        [<a href="https://2024.ccneuro.org/pdf/529_Paper_authored_Authored_Frontoparietal-regions-engaged-in-physical-prediction.pdf" class="text-primary">Abstract</a>]
        [<a href="https://drive.google.com/file/d/1Vd9YlzkjnQFcXEGTARrBPJUWish5i7AB/view?usp=sharing" class="text-primary">Poster</a>]
        </p>
      </div>
    </div>
  </div>
...
<div class="card mb-3" style="max-width: 1280px; card-cap-padding-x: 500px; card-cap-padding-y: 500px;">
  <div class="row no-gutters">
    <div class="col-md-4">
